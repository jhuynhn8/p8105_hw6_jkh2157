...
Three-Way Interaction Model (Head × Length × Sex)
...
![](p8105_hw6_jkh2157_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->
...
- After these analyses, the cross-validated RMSE showed that the
  theory-driven model had the highest prediction error, while the model
  using length and gestational age performed noticeably better. The full
  interaction model using head circumference, length, and sex produced
  the lowest RMSE, indicating the strongest predictive performance.
